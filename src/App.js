...
function App() {
  ...
  const [engravingSide, setEngravingSide] = useState("front");
  ...
  const sections = [
    ...
    <Engravings onContinue={() => setCurrentSection(2)} onBack={() => setCurrentSection(0)} engravingSide={engravingSide} selectedFont={selectedFont} engravingMessage={engravingMessage} setEngravingSide={setEngravingSide} setSelectedFont={setSelectedFont} setEngravingMessage={setEngravingMessage}/>,
    ...
    <ConfirmDetails orderNum={orderNum} locketCode={locketCode} engravingMessage={engravingMessage} selectedFont={selectedFont} engravingSide={engravingSide} editedImages={editedImages} onContinue={() => setCurrentSection(6)} onBack={() => setCurrentSection(3)}/>,
